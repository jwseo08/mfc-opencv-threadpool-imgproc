...
코드를 다운로드 받고 Visual Studio 2022를 이용해서 ImgProcAmp.sln 파일을 엽니다. 솔루션 구성과 솔루션 플랫폼을 Release와 x64로 설정하고 빌드 메뉴를 이용하여 솔루션을 빌드합니다. 빌드 결과물인 프로그램 실행파일은 x64/Release 폴더에 생성됩니다. x64/Release 폴더에는 프로그램 실행 시 필요한 OpenCV DLL이 포함되어 있습니다.
